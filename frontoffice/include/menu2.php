    ...
    <div class="container-fluid px-4">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto p-4 p-lg-0">
                    ...
                    <a href="news.php" class="nav-link-emploidb <?= basename($_SERVER['PHP_SELF']) == 'news.php' ? 'active' : '' ?>">
                        <i class="fas fa-newspaper me-1"></i>Actualités
                        <span class="badge bg-primary ms-1" style="font-size: 0.7rem;">Nouveau</span>
                    </a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link-emploidb dropdown-toggle" data-bs-toggle="dropdown">
                            <i class="fas fa-rocket me-1"></i>Fonctionnalités
                        </a>
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="ai_job_search.php" class="dropdown-item">
                                <i class="fas fa-brain me-2"></i>Recherche IA
                                <span class="badge bg-success ms-2" style="font-size: 0.6rem;">IA</span>
                            </a>
                            <a href="multilingual_jobs.php" class="dropdown-item">
                                <i class="fas fa-globe me-2"></i>Offres Multilingues
                                <span class="badge bg-warning ms-2" style="font-size: 0.6rem;">i18n</span>
                            </a>
                            <a href="salary_insights.php" class="dropdown-item">
                                <i class="fas fa-dollar-sign me-2"></i>Insights Salaires
                            </a>
                            <a href="job_alerts.php" class="dropdown-item">
                    ...
                    <div class="nav-item dropdown ms-lg-3">
                        ...
                        <div class="dropdown-menu dropdown-menu-end rounded-0 m-0" style="min-width: 280px;">
                            <div class="dropdown-header bg-primary text-white">
                                <h6 class="mb-0"><i class="fas fa-sign-in-alt me-2"></i>Se connecter</h6>
                            </div>
                            <div class="p-3">
                    ...
                    <div class="nav-item dropdown ms-lg-3">
                        ...
                        <div class="dropdown-menu dropdown-menu-end rounded-0 m-0" style="min-width: 280px;">
                            ...
                            <div class="p-3">
                                <form action="login.php" method="POST" class="mb-3">
                                    <button href="login.php" type="submit" class="btn btn-primary btn-sm w-100 text-center">
                                        <i class="fas fa-sign-in-alt me-1"></i>Login
                                    </button>
                                    
                                    <button href="login.php" type="submit" class="btn btn-danger btn-sm w-100  mt-2 mb-0 text-center">
                                        <i class="fas fa-shield-alt me-1"></i>Administartion
                                    </button>
                                          <hr class="my-2">
                                <div class="text-center">
                                    <a href="registration/select.php"><small  class="text-muted">Pas encore de compte?</small></a>
                                </div>
                                </form>
                            </div>
                            <div class="dropdown-header bg-success text-white">
                            ...
                            <div class="p-3">
                                <div class="d-grid gap-2">
                                    ...
                                    <a href="advetiser/register.php" class="btn btn-outline-warning btn-sm">
                                        <i class="fas fa-bullhorn me-1"></i>Annoncer/Advertiser
                                    </a>
