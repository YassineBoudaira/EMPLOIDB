...
if(isset($_POST['submit'])){
  ...
  $req->execute([$nom,$prenom,$telephone,$adresse,$date_n,$user_id,$ville_id,$id]);
    header('location: /profile/index.php?msg=updated');
  }
?>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                        <button name="submit" class="btn btn-outline-warning"><a href="/profile/add.php">Ajouter un profile</a></button><button name="submit" class="btn btn-outline-primary">Modifier</button>
                       </div>
                    </form> 
                </div>
            </div>
