    ...
    <div class="leftpanelinner">
      ...
      <div class="tab-content">
        ...
        <?php if ($_SESSION['role']=='admin'){?>
          ...
          <ul class="nav nav-pills nav-stacked nav-quirk">
            <!-- <li class=""><a href="/profile/profile utilisateur.php"><i class="fa fa-home"></i> <span>Mon Profile</span></a></li> -->

            <li><a href="/domend/domandes.php"><span class="text text-md btn-success btn-danger  pull-right ">+++</span><i class="fa fa-cube"></i> <span>Domandes</span></a></li>
          </ul>
          ...
          <?php if ($_SESSION['role']=='admin'){?>
            ...
            <li class="nav-parent">
              ...
              <ul class="children">
                <li><a href="/profile/index.php">Liste des profiles</a></li>
                <li><a href="/profile/add.php">Ajouter une profile</a></li>
              </ul>
            </li>
            <?php } ?>
            ...
            <li class="nav-parent">
              ...
              <ul class="children">
                <li><a href="/annonce/index.php">Liste des annonces</a></li>
                <li><a href="/annonce/add.php">Ajouter une annonce</a></li>
              </ul>
            </li> 
            ...
            <li class="nav-parent">
              ...
              <ul class="children">
                <li><a href="/domaine/index.php">Liste des domaines</a></li>
                <li><a href="/domaine/add.php">Ajouter une domaine</a></li>
              </ul>
            </li>
             <!-- ########################me##################### -->
            <li class="nav-parent">
              ...
              <ul class="children">
                <li><a href="/ville/index.php">Liste des villes</a></li>
                <li><a href="/ville/add.php">Ajouter une ville</a></li>
              </ul>
            </li>
            <li class="nav-parent">
              <a href="#"><i class="fa fa-check-square"></i> <span>contrats</span></a>
              <ul class="children">
                <li><a href="/contrat/index.php">Liste des contrats</a></li>
                <li><a href="/contrat/add.php">Ajouter une contrat</a></li>
              </ul>
            </li>
            <li class="nav-parent">
              <a href="#"><i class="fa fa-check-square"></i> <span>utilisateurs</span></a>
              <ul class="children">
                <li><a href="/user/index.php">Liste des utilisateurs</a></li>
