...
if(isset($_POST['submit'])){
    ...
    $req->execute([$nom]);
    header('location: /ville/index.php?msg=added');
}
?>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" >
                        ...
                        <div class="form-group">
                            <button name="submit" class="btn btn-outline-primary"><a href="/ville/index.php">Routeur a la page des villes</a></button>
                        </div>
                    </form>
                </div>
            </div>
