...
if(isset($_POST['submit'])){
    ...
    $req->execute([$nom,$id]);
    header('location: /domaine/index.php?msg=updated');
}
?>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" >
                        ...
                        <div class="form-group">
                        <button name="submit" class="btn btn-outline-warning"><a href="/domaine/add.php">Ajouter un domaine</a></button> <button name="submit" type="submit" class="btn btn-outline-warning" ><a href="/domaine/index.php">Afichier Domaines</a></button>
                        </div>
                        </form>
