...
//   die();
    ...
    header('location: /annonce/index.php?msg=updated');
            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                        <button name="submit" class="btn btn-outline-warning"><a href="/annonce/add.php">Ajouter une annance</a></button> <button name="submit" class="btn btn-outline-warning">Modifier</button>
                        </div>
                    </form>
                </div>
            </div>
