...
if(isset($_POST['submit'])){
    ...
    header('location: /user/index.php?msg=updated');
  }
?>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" >
                        ...
                        <div class="form-group">
                        <button name="submit" class="btn btn-outline-warning"><a href="/user/add.php">Ajouter un type utilisateur</a></button> <button name="submit" class="btn btn-outline-warning"><a>Modifier</a></button>
                        </div>
                    </form>
                </div>
            </div>
