...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $db->update("UPDATE employers SET 
            company_name = ?, 
            company_description = ?, 
            company_website = ?, 
            industry = ?, 
            ...
            founded_year = ?
            WHERE user_id = ?", [
            $company_name, $company_description, $website, $industry, $company_size, $founded_year, $user_id
        ]);
...
<head>
    ...
    <title>Profil de l'entreprise - <?= htmlspecialchars($employer['company_name']) ?> | JobMaroc</title>
                    ...
                    <form method="POST" action="">
                            ...
                            <div class="col-md-6">
                                <div class="form-group element-spacing">
                                    ...
                                    <input type="text" class="form-control" id="company_name" name="company_name" 
                                           value="<?= htmlspecialchars($employer['company_name']) ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group element-spacing">
                                    ...
                                    <input type="url" class="form-control" id="website" name="website" 
                                           value="<?= htmlspecialchars($employer['company_website'] ?? '') ?>" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group element-spacing">
                                    ...
                                    <select class="form-select" id="industry" name="industry">
                                        ...
                                        <option value="Technology" <?= ($employer['industry'] ?? '') === 'Technology' ? 'selected' : '' ?>>Technologie</option>
                                        <option value="Finance" <?= ($employer['industry'] ?? '') === 'Finance' ? 'selected' : '' ?>>Finance</option>
                                        <option value="Healthcare" <?= ($employer['industry'] ?? '') === 'Healthcare' ? 'selected' : '' ?>>Santé</option>
                                        <option value="Education" <?= ($employer['industry'] ?? '') === 'Education' ? 'selected' : '' ?>>Éducation</option>
                                        <option value="Manufacturing" <?= ($employer['industry'] ?? '') === 'Manufacturing' ? 'selected' : '' ?>>Manufacture</option>
                                        <option value="Retail" <?= ($employer['industry'] ?? '') === 'Retail' ? 'selected' : '' ?>>Commerce</option>
                                        <option value="Consulting" <?= ($employer['industry'] ?? '') === 'Consulting' ? 'selected' : '' ?>>Conseil</option>
                                        <option value="Other" <?= ($employer['industry'] ?? '') === 'Other' ? 'selected' : '' ?>>Autre</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group element-spacing">
                                    ...
                                    <select class="form-select" id="company_size" name="company_size">
                                        ...
                                        <option value="1-10" <?= ($employer['company_size'] ?? '') === '1-10' ? 'selected' : '' ?>>1-10 employés</option>
                                        <option value="11-50" <?= ($employer['company_size'] ?? '') === '11-50' ? 'selected' : '' ?>>11-50 employés</option>
                                        <option value="51-200" <?= ($employer['company_size'] ?? '') === '51-200' ? 'selected' : '' ?>>51-200 employés</option>
                                        <option value="201-500" <?= ($employer['company_size'] ?? '') === '201-500' ? 'selected' : '' ?>>201-500 employés</option>
                                        <option value="501-1000" <?= ($employer['company_size'] ?? '') === '501-1000' ? 'selected' : '' ?>>501-1000 employés</option>
                                        <option value="1000+" <?= ($employer['company_size'] ?? '') === '1000+' ? 'selected' : '' ?>>1000+ employés</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group element-spacing">
                            ...
                            <textarea class="form-control" id="company_description" name="company_description" 
                                      placeholder="Décrivez votre entreprise, sa mission, ses valeurs..."><?= htmlspecialchars($employer['company_description'] ?? '') ?></textarea>
                        </div>
