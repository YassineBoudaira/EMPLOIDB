        ...
        <div class="employer-content" id="employerContent">
            ...
            <div class="employer-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="mb-2" style="font-size: 1.875rem; font-weight: 900; color: #1e40af;">
                            <i class="fas fa-file-alt me-3"></i>Gérer les candidatures
                        </h1>
                    ...
                    <div class="d-flex gap-2">
                        <a href="manage_jobs.php" class="btn btn-outline-primary btn-sm">
                    ...
                    <div class="col-12">
                        <?php if (empty($applications)): ?>
                            <div class="text-center py-5">
                                ...
                                <h4 class="text-muted">Aucune candidature reçue</h4>
                                <p class="text-muted">Les candidatures apparaîtront ici une fois que vous aurez publié des offres d'emploi.</p>
                                ...
                                <div class="application-card">
                                    <div class="application-header">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                <h5 class="mb-1"><?= htmlspecialchars($application['first_name'] . ' ' . $application['last_name']) ?></h5>
                                                <p class="text-muted mb-2"><?= htmlspecialchars($application['job_title']) ?></p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="mb-3">
                                                    ...
                                                    <p class="mb-1">Email: <?= htmlspecialchars($application['email']) ?></p>
                                                    <?php if ($application['phone']): ?>
                                                        <p class="mb-0">Téléphone: <?= htmlspecialchars($application['phone']) ?></p>
                                                    <?php endif; ?>
                                                </div>
                                                
                                                <?php if ($application['cover_letter']): ?>
                                                    <div class="mb-3">
                                                        <h6><i class="fas fa-file-alt me-2"></i>Lettre de motivation</h6>
                                                        <p class="text-muted"><?= nl2br(htmlspecialchars($application['cover_letter'])) ?></p>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="d-grid gap-2">
                                                    <?php if ($application['cv_path']): ?>
                                                        <a href="../<?= htmlspecialchars($application['cv_path']) ?>" target="_blank" class="btn btn-outline-primary btn-sm">
                                                            <i class="fas fa-download me-2"></i>
                                                            Télécharger CV
                                                        </a>
                                                    <?php endif; ?>
                                                    
                                                    <a href="view_application.php?id=<?= $application['id'] ?>" class="btn btn-primary btn-sm">
                                                    ...
                                                    <form method="POST" action="" class="d-inline">
                                                        ...
                                                        <select name="new_status" class="form-select form-select-sm" onchange="this.form.submit()">
                                                            ...
                                                            <option value="viewed" <?= $application['status'] === 'viewed' ? 'selected' : '' ?>>Marquer comme vue</option>
                                                            <option value="shortlisted" <?= $application['status'] === 'shortlisted' ? 'selected' : '' ?>>Sélectionner</option>
                                                            <option value="interviewed" <?= $application['status'] === 'interviewed' ? 'selected' : '' ?>>Entretien</option>
                                                            <option value="hired" <?= $application['status'] === 'hired' ? 'selected' : '' ?>>Embaucher</option>
