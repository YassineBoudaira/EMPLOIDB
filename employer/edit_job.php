...
$job = $db->fetch("SELECT * FROM annonces WHERE id = ? AND profile_id = ?", [$job_id, $employer_profile['id']]);
if (!$job) {
    header('Location: dashboard.php');
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Update job posting
        $db->update("UPDATE annonces SET 
            titre = ?, description = ?, domaine_id = ?, ville_id = ?, contrat_id = ?,
            ...
            application_deadline = ?, telephone = ?, email = ?, status = ?
            WHERE id = ? AND profile_id = ?", [
            $titre, $description, $domaine_id, $ville_id, $contrat_id,
            $salary_min, $salary_max, $job_type, $remote_work, $urgent, $featured,
            $requirements, $benefits, $skills_required, $experience_level, $education_level,
            $application_deadline, $telephone, $email, $status, $job_id, $employer_profile['id']
        ]);
        ...
        $success = true;
        $success_message = 'Offre d\'emploi mise à jour avec succès !';
...
<head>
    ...
    <title>Modifier l'offre - <?= htmlspecialchars($job['titre']) ?> | JobMaroc</title>
            ...
            <div class="edit-job-card">
                <div class="card-header">
                    <h3 class="mb-0">
                        ...
                        Modifier l'offre : <?= htmlspecialchars($job['titre']) ?>
                    </h3>
                    <p class="mb-0 mt-2 opacity-75">Modifiez les informations de votre offre d'emploi</p>
                </div>
                ...
                <div class="card-body">
                    ...
                    <?php if ($success): ?>
                        <div class="alert alert-success">
                            ...
                            <p class="mb-0 mt-2">Votre offre d'emploi a été mise à jour avec succès.</p>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-8">
                                <div class="form-group element-spacing">
                                    ...
                                    <input type="text" class="form-control" id="titre" name="titre" 
                                           value="<?= htmlspecialchars($job['titre']) ?>" required
                                    ...
                                    <select class="form-select" id="domaine_id" name="domaine_id" required>
                                        ...
                                        <?php foreach ($domaines as $domaine): ?>
                                            <option value="<?= $domaine['id'] ?>" 
                                                    <?= $job['domaine_id'] == $domaine['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="form-group element-spacing">
                            ...
                            <textarea class="form-control" id="description" name="description" required
                                      placeholder="Décrivez en détail le poste, les responsabilités, les missions..."><?= htmlspecialchars($job['description']) ?></textarea>
                        </div>
                                    ...
                                    <select class="form-select" id="ville_id" name="ville_id" required>
                                        ...
                                        <?php foreach ($villes as $ville): ?>
                                            <option value="<?= $ville['id'] ?>" 
                                                    <?= $job['ville_id'] == $ville['id'] ? 'selected' : '' ?>>
                                    ...
                                    <select class="form-select" id="contrat_id" name="contrat_id" required>
                                        ...
                                        <?php foreach ($contrats as $contrat): ?>
                                            <option value="<?= $contrat['id'] ?>" 
                                                    <?= $job['contrat_id'] == $contrat['id'] ? 'selected' : '' ?>>
                            ...
                            <div class="col-md-4">
                                <div class="form-group element-spacing">
                                    ...
                                    <select class="form-select" id="job_type" name="job_type">
                                        <option value="full-time" <?= $job['job_type'] === 'full-time' ? 'selected' : '' ?>>Temps plein</option>
                                        <option value="part-time" <?= $job['job_type'] === 'part-time' ? 'selected' : '' ?>>Temps partiel</option>
                                        <option value="contract" <?= $job['job_type'] === 'contract' ? 'selected' : '' ?>>Contrat</option>
                                        <option value="internship" <?= $job['job_type'] === 'internship' ? 'selected' : '' ?>>Stage</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group element-spacing">
                            ...
                            <textarea class="form-control" id="requirements" name="requirements" 
                                      placeholder="Listez les exigences pour ce poste..."><?= htmlspecialchars($job['requirements']) ?></textarea>
                        </div>
                        ...
                        <div class="form-group element-spacing">
                            ...
                            <textarea class="form-control" id="skills_required" name="skills_required" 
                                      placeholder="Ex: PHP, MySQL, JavaScript, Git..."><?= htmlspecialchars($job['skills_required']) ?></textarea>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group element-spacing">
                                    ...
                                    <select class="form-select" id="experience_level" name="experience_level">
                                        ...
                                        <option value="mid" <?= $job['experience_level'] === 'mid' ? 'selected' : '' ?>>Intermédiaire</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group element-spacing">
                                    ...
                                    <select class="form-select" id="education_level" name="education_level">
                                        <option value="any" <?= $job['education_level'] === 'any' ? 'selected' : '' ?>>Tous niveaux</option>
                                        <option value="bac" <?= $job['education_level'] === 'bac' ? 'selected' : '' ?>>Bac</option>
                                        <option value="bac+2" <?= $job['education_level'] === 'bac+2' ? 'selected' : '' ?>>Bac+2</option>
                                        <option value="bac+3" <?= $job['education_level'] === 'bac+3' ? 'selected' : '' ?>>Bac+3</option>
                                        <option value="bac+4" <?= $job['education_level'] === 'bac+4' ? 'selected' : '' ?>>Bac+4</option>
                                        <option value="bac+5" <?= $job['education_level'] === 'bac+5' ? 'selected' : '' ?>>Bac+5</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group element-spacing">
                            ...
                            <textarea class="form-control" id="benefits" name="benefits" 
                                      placeholder="Listez les avantages offerts (mutuelle, tickets restaurant, etc.)..."><?= htmlspecialchars($job['benefits']) ?></textarea>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group element-spacing">
                                    ...
                                    <select class="form-select" id="remote_work" name="remote_work">
                                        <option value="on-site" <?= $job['remote_work'] === 'on-site' ? 'selected' : '' ?>>Sur site</option>
                                        <option value="hybrid" <?= $job['remote_work'] === 'hybrid' ? 'selected' : '' ?>>Hybride</option>
                                        <option value="remote" <?= $job['remote_work'] === 'remote' ? 'selected' : '' ?>>Télétravail</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group element-spacing">
                                    ...
                                    <input type="tel" class="form-control" id="telephone" name="telephone" 
                                           value="<?= htmlspecialchars($job['telephone']) ?>" 
                        ...
                        <?php if ($job['image']): ?>
                            <div class="form-group element-spacing">
                                ...
                                <img src="../upload/<?= htmlspecialchars($job['image']) ?>" alt="Image de l'offre" class="current-image">
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group element-spacing">
                                    <label for="status" class="form-label">Statut de l'offre</label>
                                    <select class="form-select" id="status" name="status">
                                        <option value="active" <?= $job['status'] === 'active' ? 'selected' : '' ?>>Active</option>
                                        <option value="paused" <?= $job['status'] === 'paused' ? 'selected' : '' ?>>En pause</option>
