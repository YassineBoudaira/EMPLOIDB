...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($action === 'change_password') {
            ...
            if (!Security::verifyPassword($current_password, $user['pass'])) {
            ...
            // Update email
            $new_email = Security::sanitizeInput($_POST['new_email'] ?? '');
            ...
            $existing_user = $db->fetch("SELECT id FROM users WHERE email = ? AND id != ?", [$new_email, $user_id]);
            if ($existing_user) {
            ...
            $success = true;
            $success_message = 'Adresse email mise à jour avec succès !';
            ...
            // Update notification settings (you might need to create a settings table)
...
<head>
    ...
    <title>Paramètres - <?= htmlspecialchars($employer['company_name']) ?> | JobMaroc</title>
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="job_alerts">
                                Alertes pour les nouvelles offres d'emploi
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="application_updates">
                                Mises à jour sur les candidatures
                            </label>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p><strong>Nom d'entreprise:</strong> <?= htmlspecialchars($employer['company_name']) ?></p>
                        ...
                        <div class="col-md-6">
                            <h5>Actions</h5>
                            <a href="profile.php" class="btn btn-outline-primary mb-2 w-100">
