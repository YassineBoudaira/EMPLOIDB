            ...
            <div class="container-fluid p-0">
                <div class="owl-carousel header-carousel position-relative">
                    <div class="owl-carousel-item position-relative">
                        ...
                        <div class="position-static top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: linear-gradient(135deg, rgba(37, 99, 235, 0.8) 0%, rgba(5, 150, 105, 0.6) 100%);">
                            <div class="container">
                                        ...
                                        <div class="emploidb-animate-fade-in-up">
                                            ...
                                            <div class="d-flex flex-wrap gap-3 mb-5">
                                                ...
                                                <a href="signup.php" class="emploidb-btn emploidb-btn-outline emploidb-btn-lg emploidb-hover-lift" style="border-color: white; color: white;">
                                                    <i class="fas fa-user-plus me-2"></i>Créer un Compte condidat
                                                </a>
                                                ...
                                                <a href="advertiser/register.php" class="emploidb-btn emploidb-btn-worning emploidb-btn-lg emploidb-hover-lift">
                                                    <i class="fas fa-bullhorn me-2"></i>Annoncer une offre
                                                </a>
                                            </div>
                                                ...
                                                <div class="col-6 col-md-3">
                                                    <div class="text-center">
                                                        <div class="emploidb-text-3xl emploidb-font-black text-white mb-1">
                                                            <?php 
                                                            try {
                                                                $localJobs = $db->fetch("SELECT COUNT(*) as count FROM annonces WHERE status = 'active'")['count'] ?? 0;
                                                                $aggregatedJobs = $db->fetch("SELECT COUNT(*) as count FROM aggregated_jobs WHERE status = 'active'")['count'] ?? 0;
                                                                echo number_format($localJobs + $aggregatedJobs);
                                                            } catch (Exception $e) {
                                                                echo '500+';
                                                            }
                                                            ?>
