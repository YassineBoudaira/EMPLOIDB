...
INSERT IGNORE INTO `postulation` (`id`, `annonce_id`, `nom_prenom`, `telephone`, `email`, `lien`, `fichier`, `message`) VALUES
	...
	(9, 5, 'zad hacker', '0699978877', 'zaddfgdfhacker@gmail.com', 'www.google.ma', 'UseCase.pdf', 'http://localhost:8080/domend/domandes.php\r\nhttp://localhost:8080/domend/domandes.php\r\nhttp://localhost:8080/domend/domandes.php\r\nhttp://localhost:8080/domend/domandes.php'),
