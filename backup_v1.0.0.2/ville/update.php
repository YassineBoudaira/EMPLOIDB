...
if(isset($_POST['submit'])){
    ...
    $req->execute([$nom,$id]);
    header('location: /ville/index.php?msg=updated');
}
?>
                ...
                <div class="card-body">
                    <form method="post" >
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                        <button name="submit" class="btn btn-outline-warning"><a href="/ville/add.php">Ajouter un ville</a></button> <button name="submit" class="btn btn-outline-warning">Modifier</button>
                        </div>
                    </form>
                </div>
            </div>
