...
if(isset($_POST['submit'])){
    ...
    $req->execute([$nom,$id]);
    header('location: /contrat/index.php?msg=updated');
}
?>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                        <button name="submit" class="btn btn-outline-warning"><a href="/contrat/add.php">Ajouter un contrat</a></button> <button name="submit" class="btn btn-outline-warning" ><a href='/contrat/index.php'> Afichier les Contrats </a></button>
                        </div>
                </div>
            </div>
