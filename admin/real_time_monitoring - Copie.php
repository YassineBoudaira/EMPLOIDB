            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    <div class="text-center">
                        ...
                        <h5 class="text-primary mb-1"><?= $system_metrics['uptime'] ?? '99.9%' ?></h5>
                ...
                <div class="col-md-3 mb-3">
                    <div class="text-center">
                        ...
                        <h5 class="text-success mb-1"><?= $system_metrics['response_time'] ?? rand(50, 200) ?>ms</h5>
                ...
                <div class="col-md-3 mb-3">
                    <div class="text-center">
                        ...
                        <h5 class="text-warning mb-1"><?= $system_metrics['error_rate'] ?? rand(0, 5) ?>%</h5>
                ...
                <div class="col-md-3 mb-3">
                    <div class="text-center">
                        ...
                        <h5 class="text-info mb-1"><?= $system_metrics['security_score'] ?? rand(85, 98) ?>/100</h5>
