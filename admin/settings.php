                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    <h5 class="fw-bold mb-0">
                                                        <i class="fas fa-envelope text-primary me-2"></i>
                                                        Configuration Email Enterprise
                                                    </h5>
                                                    <p class="text-muted mb-0">Gestion complète du système d'emailing professionnel</p>
                                                </div>
                                                <div class="d-flex gap-2">
                                                    <button class="enterprise-btn enterprise-btn-outline" onclick="testEmailConnection()">
                                                        <i class="fas fa-plug me-2"></i>Tester Connexion
                                                    </button>
                                                    <button class="enterprise-btn enterprise-btn-primary" onclick="saveEmailConfig()">
                                    ...
                                    <div class="enterprise-card">
                                        <div class="enterprise-card-header">
                                            <ul class="nav nav-tabs card-header-tabs" id="emailTabs" role="tablist">
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link" id="security-tab" data-bs-toggle="tab" data-bs-target="#email-security" type="button" role="tab">
                                                        <i class="fas fa-shield-alt me-2"></i>Sécurité
                                                    </button>
                                                </li>
                                            </ul>
                                                ...
                                                <div class="tab-pane fade show active" id="smtp" role="tabpanel">
                                                    <form method="POST" action="">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-4">
                                                                    <label for="smtp_timeout" class="form-label fw-semibold">
                                                                        <i class="fas fa-clock text-primary me-2"></i>
                                                                        Timeout (secondes)
                                                                    </label>
                                                                    <input type="number" class="form-control form-control-lg" id="smtp_timeout" name="smtp_timeout" 
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-4">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-lg" id="from_name" name="from_name" 
                                                                           value="EMPLOIDB" placeholder="EMPLOIDB">
                                                                    <div class="form-text">Nom affiché dans les emails</div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="mb-4">
                                                                    ...
                                                                    <input type="email" class="form-control form-control-lg" id="from_email" name="from_email" 
                                                                           value="noreply@emploidb.com" placeholder="noreply@emploidb.com">
                                                                    <div class="form-text">Adresse email d'expédition</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="enterprise-card h-100">
                                                                <div class="enterprise-card-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Template de Bienvenue</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer l'email de bienvenue</label>
                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Template de Candidature</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer la confirmation de candidature</label>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Template de Réponse Employeur</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer les notifications employeur</label>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Template de Newsletter</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Template de Mot de Passe Oublié</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer la récupération de mot de passe</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="enterprise-card h-100">
                                                                <div class="enterprise-card-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Logo de l'Email</label>
                                                                        <input type="file" class="form-control" accept="image/*">
                                                                        <div class="form-text">Logo affiché dans les emails</div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Signature Email</label>
                                                                        <textarea class="form-control" rows="4" placeholder="Cordialement,
L'équipe EMPLOIDB
www.emploidb.com"></textarea>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Footer Email</label>
                                                                        <textarea class="form-control" rows="3" placeholder="© 2024 EMPLOIDB. Tous droits réservés.
Vous recevez cet email car vous êtes inscrit sur notre plateforme."></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="enterprise-card h-100">
                                                                <div class="enterprise-card-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Emails Automatiques</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer l'automatisation</label>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Délai d'Envoi</label>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Séquence de Bienvenue</label>
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Email 1: Bienvenue</label>
                                                                        </div>
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Email 2: Guide d'utilisation</label>
                                                                        </div>
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="checkbox">
                                                                            <label class="form-check-label">Email 3: Conseils carrière</label>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Rappels de Candidature</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer les rappels</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="enterprise-card h-100">
                                                                <div class="enterprise-card-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Limite d'Emails par Heure</label>
                                                                        <input type="number" class="form-control" value="100" min="1" max="1000">
                                                                        <div class="form-text">Nombre maximum d'emails par heure</div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Limite d'Emails par Jour</label>
                                                                        <input type="number" class="form-control" value="1000" min="1" max="10000">
                                                                        <div class="form-text">Nombre maximum d'emails par jour</div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Gestion des Bounces</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer la gestion des bounces</label>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Désabonnement Automatique</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer le désabonnement</label>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Heures d'Envoi</label>
                                                                        <div class="row">
                                                                            <div class="col-6">
                                                            ...
                                                            <div class="enterprise-card h-100">
                                                                <div class="enterprise-card-body">
                                                                    ...
                                                                    <div class="row text-center">
                                                                        <div class="col-6">
                                                                            <div class="enterprise-stat-number text-success mb-1">2,450</div>
                                                                            <div class="enterprise-stat-label">Emails Envoyés</div>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <div class="enterprise-stat-number text-info mb-1">1,890</div>
                                                                            <div class="enterprise-stat-label">Emails Ouverts</div>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="row text-center mt-3">
                                                                        <div class="col-6">
                                                                            <div class="enterprise-stat-number text-warning mb-1">156</div>
                                                                            <div class="enterprise-stat-label">Clics</div>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <div class="enterprise-stat-number text-danger mb-1">23</div>
                                                                            <div class="enterprise-stat-label">Bounces</div>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="mt-4">
                                                                        <h6 class="fw-bold">Taux d'Ouverture</h6>
                                                                        <div class="progress mb-2" style="height: 8px;">
                                                                            <div class="progress-bar bg-success" style="width: 77%">77%</div>
                                                                        </div>
                                                                        
                                                                        <h6 class="fw-bold">Taux de Clic</h6>
                                                                        <div class="progress mb-2" style="height: 8px;">
                                                                            <div class="progress-bar bg-info" style="width: 6.4%">6.4%</div>
                                                                        </div>
                                                                        
                                                                        <h6 class="fw-bold">Taux de Bounce</h6>
                                                                        <div class="progress mb-2" style="height: 8px;">
                                                                            <div class="progress-bar bg-danger" style="width: 0.9%">0.9%</div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="enterprise-card h-100">
                                                                <div class="enterprise-card-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Tracking des Ouvertures</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer le tracking</label>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Tracking des Clics</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer le tracking des clics</label>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Pixels de Suivi</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer les pixels de suivi</label>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Rapports Automatiques</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Envoyer des rapports</label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="d-flex gap-2">
                                                                        <button class="enterprise-btn enterprise-btn-outline" onclick="generateEmailReport()">
                                                                            <i class="fas fa-file-pdf me-2"></i>Rapport PDF
                                                                        </button>
                                                                        <button class="enterprise-btn enterprise-btn-primary" onclick="exportEmailData()">
                                                ...
                                                <!-- Email Security -->
                                                <div class="tab-pane fade" id="email-security" role="tabpanel">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="enterprise-card h-100">
                                                                <div class="enterprise-card-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Authentification DKIM</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer DKIM</label>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Clé DKIM</label>
                                                                        <textarea class="form-control" rows="3" placeholder="votre-clé-dkim-ici"></textarea>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Authentification SPF</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer SPF</label>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Enregistrement SPF</label>
                                                                        <input type="text" class="form-control" value="v=spf1 include:_spf.google.com ~all">
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Authentification DMARC</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer DMARC</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="enterprise-card h-100">
                                                                <div class="enterprise-card-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Filtre Anti-Spam</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer le filtre</label>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Liste Noire</label>
                                                                        <textarea class="form-control" rows="3" placeholder="spam@example.com, fake@domain.com"></textarea>
                                                                        <div class="form-text">Emails bloqués</div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Liste Blanche</label>
                                                                        <textarea class="form-control" rows="3" placeholder="trusted@partner.com, verified@client.com"></textarea>
                                                                        <div class="form-text">Emails autorisés</div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Limite de Taille</label>
                                                                        <input type="number" class="form-control" value="25" min="1" max="100">
                                                                        <div class="form-text">Taille maximale en MB</div>
                                                                    </div>
                                                                    
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-semibold">Scan de Virus</label>
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" checked>
                                                                            <label class="form-check-label">Activer le scan de virus</label>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div class="d-flex gap-2">
                                                                        <button class="enterprise-btn enterprise-btn-outline" onclick="testEmailSecurity()">
                                                                            <i class="fas fa-shield-alt me-2"></i>Tester Sécurité
                                                                        </button>
                                                                        <button class="enterprise-btn enterprise-btn-primary" onclick="saveEmailSecurity()">
                                                                            <i class="fas fa-save me-2"></i>Sauvegarder
                                                                        </button>
                                                                    </div>
                                                                </div>
...
// Enhanced Email System Functions
function testEmailConnection() {
    if (confirm('Voulez-vous tester la connexion SMTP ?')) {
        alert('Test de connexion SMTP en cours...');
        setTimeout(() => {
            alert('Test terminé - Connexion SMTP réussie !');
        }, 3000);
    }
}
...
function generateEmailReport() {
    if (confirm('Voulez-vous générer un rapport PDF des statistiques email ?')) {
...
function exportEmailData() {
    if (confirm('Voulez-vous exporter les données email ?')) {
...
function testEmailSecurity() {
    if (confirm('Voulez-vous tester la sécurité email (DKIM, SPF, DMARC) ?')) {
        alert('Test de sécurité email en cours...');
        setTimeout(() => {
            alert('Test terminé - Toutes les authentifications sont valides !');
        }, 2500);
    }
}

function saveEmailSecurity() {
    alert('Configuration de sécurité email sauvegardée !');
}

// Email Analytics Auto-Update
setInterval(() => {
    // Update email statistics
    const sentElement = document.querySelector('.enterprise-stat-number.text-success');
    const openedElement = document.querySelector('.enterprise-stat-number.text-info');
    const clicksElement = document.querySelector('.enterprise-stat-number.text-warning');
    const bouncesElement = document.querySelector('.enterprise-stat-number.text-danger');
    
    if (sentElement && openedElement && clicksElement && bouncesElement) {
        // Simulate real-time email statistics updates
        const newSent = parseInt(sentElement.textContent.replace(',', '')) + Math.floor(Math.random() * 5);
        const newOpened = parseInt(openedElement.textContent.replace(',', '')) + Math.floor(Math.random() * 3);
        const newClicks = parseInt(clicksElement.textContent) + Math.floor(Math.random() * 2);
        const newBounces = parseInt(bouncesElement.textContent) + Math.floor(Math.random() * 1);
        
        sentElement.textContent = newSent.toLocaleString();
        openedElement.textContent = newOpened.toLocaleString();
        clicksElement.textContent = newClicks;
        bouncesElement.textContent = newBounces;
        
        // Update progress bars
        const openRate = Math.round((newOpened / newSent) * 100);
        const clickRate = Math.round((newClicks / newOpened) * 100);
        const bounceRate = Math.round((newBounces / newSent) * 100);
        
        const openProgress = document.querySelector('.progress-bar.bg-success');
        const clickProgress = document.querySelector('.progress-bar.bg-info');
        const bounceProgress = document.querySelector('.progress-bar.bg-danger');
        
        if (openProgress) {
            openProgress.style.width = openRate + '%';
            openProgress.textContent = openRate + '%';
        }
        if (clickProgress) {
            clickProgress.style.width = clickRate + '%';
            clickProgress.textContent = clickRate + '%';
        }
        if (bounceProgress) {
            bounceProgress.style.width = bounceRate + '%';
            bounceProgress.textContent = bounceRate + '%';
        }
    }
